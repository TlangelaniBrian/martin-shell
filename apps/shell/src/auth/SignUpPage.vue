...
async function onSubmit() {
  ...
  try {
    ...
    error.value = isApiError(err) ? err.detail : "Registration failed. Please try again.";
  } finally {
  ...
  <div class="auth-root">
    ...
    <div class="brand-panel">
      ...
      <div class="brand-content">
        ...
        <p class="brand-tagline">Your legal<br />intelligence layer.</p>
        ...
        <div class="brand-steps">
          <div class="brand-step">
            ...
            <div>
              ...
              <p class="step-desc">Secure, verified access in seconds</p>
            </div>
          </div>
          ...
          <div class="brand-step">
            ...
            <div>
              ...
              <p class="step-desc">One click to confirm your identity</p>
            </div>
          </div>
          <div class="step-connector" />
          <div class="brand-step">
            ...
            <div>
              <p class="step-title">Start researching</p>
              <p class="step-desc">Full access to AI-powered case analysis</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="form-inner">
        <template v-if="submitted">
          <div class="success-state">
            ...
            <RouterLink to="/sign-in" class="back-link">Back to sign in →</RouterLink>
          </div>
        </template>
        ...
        <template v-else>
          <div class="form-header">
            ...
            <p class="form-subtitle">Join Martin and start your research</p>
          </div>
...
.brand-glow {
  ...
  width: 70%;
  height: 60%;
  background: radial-gradient(ellipse at center, rgba(196, 163, 98, 0.08) 0%, transparent 70%);
  pointer-events: none;
  z-index: 1;
}
...
.wordmark-m { color: #c4a362; }
.wordmark-artin { color: #e8e2d5; }
...
.step-connector {
  width: 1px;
  height: 1.5rem;
  background: linear-gradient(to bottom, rgba(196, 163, 98, 0.3), rgba(196, 163, 98, 0.1));
...
.field-input::placeholder { color: #2e3a4e; font-weight: 400; }
...
.success-icon {
  ...
  border: 1px solid rgba(196, 163, 98, 0.3);
  display: flex;
  align-items: center;
  justify-content: center;
